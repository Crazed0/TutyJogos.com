...
function fillSudoku(board, difficultyLevel) {
    ...
    switch (difficultyLevel) {
        ...
        case 'professional':
            ...
            break;
        case 'perito':
            filledCells = Math.floor(Math.random() * 5) + 20; // Adjusted range for very hard level
            break;
        case 'deus':
            filledCells = Math.floor(Math.random() * 5) + 12; // Adjusted range for insane level
            break;
        default:
