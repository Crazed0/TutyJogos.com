                ...
                cellElement.addEventListener('click', () => {
                    if (usingNumber !== null) {
                        ...
                        if (isSafe(board, rowIndex, colIndex, num)) {
                            ...
                            // Check if Sudoku is solved after filling this cell
                            if (checkSudokuSolved(board)) {
                                // If Sudoku is solved, highlight all cells green for 3 seconds
                                highlightSolvedSudoku(sudokuBoard);
                            }
                        }
                    }
                });
